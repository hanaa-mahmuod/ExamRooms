        ...
        <div className="main">
            ...
            <div className="head  flex justify-end mr-10">
                ...
                <div className=" flex" >
                    ...
                    <Link to="folder">
                        <div><FolderIcon className="ml-10 text-primary" style={{  fontSize: 90 }} /><p className="text-center leading-8  font-poppins font-normal text-xl">Shared with me</p></div>
                    </Link>
                        <div><FolderIcon className="ml-10 text-primary" style={{  fontSize: 90 }} /><p className="text-center leading-8 font-poppins font-normal text-xl">First Semester 2024</p></div>
                        <div><FolderIcon className="ml-10 text-primary" style={{  fontSize: 90 }} /><p className="text-center leading-8 font-poppins font-normal text-xl">OS summer</p></div>
                    </div>
                </div>
                ...
                <div className="session  ">
                    ...
                    <p className=" max-[615px]:ml-3 ml-10  font-poppins font-normal text-xl">Image Processing</p>
